...
:titletext: OGC GeoPackage Extension for Tiled Gridded Coverage Data
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/geopackage-gr/1.0
|Internal reference number of this OGC(R) document:    17-066r1
|Version: 1.0
