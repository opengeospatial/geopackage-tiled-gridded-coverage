...
|name of actual http://www.geopackage.org/spec/#tiles_user_tables[tile pyramid user data table] containing unsigned integer data|`tile_data`|`gpkg_elevation_tiles`|'PNG Tiles'|`read-write`
|=======================================================================
