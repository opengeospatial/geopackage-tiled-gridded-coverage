...
|`gpkg_2d_gridded_coverage_ancillary`|null|`gpkg_elevation_tiles`|'Coverage Ancillary'|`read-write`
|`gpkg_2d_gridded_tile_ancillary`|null|`gpkg_elevation_tiles`|'Tile Ancillary'|`read-write`
|name of actual http://www.geopackage.org/spec/#tiles_user_tables[tile pyramid user data table] containing floating point data|`tile_data`|`gpkg_elevation_tiles_tiff`|'TIFF Tiles'|`read-write`
|=======================================================================
