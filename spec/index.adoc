...
[id="ogcheading"]
Publication Date: 20xx-xx-xx +
Approval Date:   20xx-xx-xx +
Submission Date: 20xx-xx-xx +
...
[title]
= OGC® GeoPackage Elevation Extension =
...
Document type:         	OGC Candidate Encoding Standard +
...
This OGC® Candidate Encoding Standard defines two GeoPackage Extensions for tiled, gridded elevation data.

== Keywords ==

ogcdoc, geopackage, sqlite, raster, tiles, vector, feature, data, storage, exchange, mobile, smartphone, tablet, elevation, tiff
...
include::1_tiled_gridded_elevation_data.adoc[]

include::2_tiled_gridded_elevation_data_tiff.adoc[]
